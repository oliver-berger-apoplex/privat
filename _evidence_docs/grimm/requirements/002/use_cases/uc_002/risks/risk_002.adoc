...
* Incorrect assignment of the analysis report, a patient with AFL is not recognized

=== Hazard
// Describe the hazard for this use case
* False negative analysis result in case the incorrect analysis is made of ecg data without AFL
